...
[![Svelte Version](https://img.shields.io/badge/Svelte-v5.56.9-FF3E00.svg?style=flat&logo=svelte)](https://svelte.dev/)
...
- **快捷触发**：可通过键盘快捷键、鼠标双击、Shift+点击或拖拽选中触发，每种方式独立配置规则
- **灵活模式**：支持立即执行或工具栏交互两大模式，自由切换应对不同场景
- **个性外观**：支持自定义 SVG 工具栏图标，并可分别自定义浅色和深色主题
- **开箱即用**：内置丰富的文本类型和处理动作，简单配置后即可使用
- **支持扩展**：支持通过正则表达式、机器学习模型、脚本或接入本地/在线 AI 等方式扩展能力
...
TextGO 是未签名应用，macOS 会将辅助功能权限与当前二进制文件绑定。应用更新后，二进制文件的身份发生变化，原有权限随之失效，即使系统设置中仍显示为已启用。
